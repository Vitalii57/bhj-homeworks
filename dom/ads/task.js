class Rotation {
  ...
  changeString() {
    ...
    this.rotator[this.activRotatorElement].style.color =
      this.rotator[this.activRotatorElement].dataset.color;
  }
  ...
  change() {
    ...
    this.changeString();
    this.rotator[this.activRotatorElement].classList.add(
    ...
    this.activRotatorElement =
      (this.activRotatorElement + 1) % this.rotator.length;
  }
}
